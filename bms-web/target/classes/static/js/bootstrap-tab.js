var addTabs= function (options) {
    ...
    //
        ...
        // } else {//没有内容，使用IFRAME打开链接
            content = '<iframe id="iframe_' + id + '" src="' + options.url +
                '" width="99%" height="100%" onload="changeFrameHeight(this)" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes"></iframe>';
        // }
    ...
    //             '" width="99%" height="100%" onload="changeFrameHeight(this)" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="yes" allowtransparency="yes"></iframe></div>';
    //     }
    //     //加入TABS
