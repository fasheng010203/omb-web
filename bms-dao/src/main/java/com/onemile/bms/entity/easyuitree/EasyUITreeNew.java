package com.onemile.bms.entity.easyuitree;
...
public class EasyUITreeNew {
    ...
    public Integer getTonConratio() {
        return tonConratio;
    }

    public void setTonConratio(Integer tonConratio) {
        this.tonConratio = tonConratio;
    }
